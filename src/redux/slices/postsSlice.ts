...
export const AddPostPust = createAsyncThunk<Post, AddPostArg>(
  "AddPost/feth",
...
export const DeletPost = createAsyncThunk<number, DeletePostarg>(
  "DeletePost/feth",
  async ({ IDPOST, token }, { dispatch, rejectWithValue }) => {
    try {
...
export const EditPost = createAsyncThunk<Post, EditPostarg>(
  "EditPost/feth",
  async ({ IDPOST, formData, token }, { dispatch, rejectWithValue }) => {
    try {
      const response = await axios.put(`${API_URL}/posts/${IDPOST}`, formData, {
        headers: {
...
const postsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(AddPostPust.fulfilled, (state, action: PayloadAction<Post>) => {
        state.loading = false;
      ...
      .addCase(DeletPost.fulfilled, (state, action: PayloadAction<number>) => {
        state.loading = false;
